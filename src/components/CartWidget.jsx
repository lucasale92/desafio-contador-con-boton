...
export default function CartWidget({items}) {
    ...
    <>
        ...
        <div className="text-end">
            <button type="button" className="btn btn-primary">Carrito    <svg xmlns="http://www.w3.org/2000/svg"  fill="currentColor" className="App-cart container" viewBox="0 0 16 16">
